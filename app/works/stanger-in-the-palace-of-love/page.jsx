            ...
            <div className="text-md sm:text-lg text-zinc-800 font-light leading-8 tracking-wide">
              ...
              <div>
                  ...
                  <div className="relative z-10">
                    <p className="text-xl text-gray-800">
                      <em className="relative">
                        <svg className="absolute -top-8 -start-8 h-16 w-16 text-gray-100 sm:h-24 sm:w-24 dark:text-gray-700" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        ...
                        <span className="text-xl relative z-10 dark:text-white">Today I believe in the possibility of love; that is why I endeavor to trace its imperfections, its perversions.—Frantz Fanon<sup><Link href="#fn1" id="ref1" className="anchor">1</Link></sup></span>
                      </em>
                    </p>
                  </div>
                </blockquote>
                ...
                <blockquote className="relative border-s-4 border-[#f0d2d2] ps-4 sm:ps-6 dark:border-gray-700">
                  <p className="text-zinc-800 sm:text-base dark:text-white">
